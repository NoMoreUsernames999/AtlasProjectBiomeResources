...
public class BiomeMarsBarren extends Biome {
    ...
    public BiomeMarsBarren() {
        ...
        super(new BiomeProperties("Mars_Barrens").setBaseHeight(0.135f).setHeightVariation(0.2f).setRainfall(0.0f).setRainDisabled().setTemperature(1.0f).setWaterColor(14837760));
