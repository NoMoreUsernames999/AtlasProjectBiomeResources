...
public class BiomeMarsCanyon extends Biome {
	...
	public BiomeMarsCanyon() {
		...
		super(new BiomeProperties("MarsCanyon").setBaseHeight(-1.0f).setHeightVariation(0.1f).setRainfall(0.0f).setRainDisabled().setTemperature(0.7f).setWaterColor(14837760)); 
