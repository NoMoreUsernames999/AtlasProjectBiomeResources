...
public class BiomeMarsFlats extends Biome {
	...
	public BiomeMarsFlats() {
		...
		super(new BiomeProperties("Mars_Flats").setBaseHeight(0.125f).setHeightVariation(0.1f).setRainfall(0.0f).setRainDisabled().setTemperature(2.0f).setWaterColor(14837760));
