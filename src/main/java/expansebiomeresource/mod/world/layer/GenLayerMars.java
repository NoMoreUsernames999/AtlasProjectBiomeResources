...
public class GenLayerMars extends GenLayer
{
    @SuppressWarnings("unchecked")
    private java.util.List<net.minecraftforge.common.BiomeManager.BiomeEntry>[] biomes = new java.util.ArrayList[net.minecraftforge.common.BiomeManager.BiomeType.values().length];
    private final ChunkGeneratorSettings settings;

    public GenLayerMars(long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, ChunkGeneratorSettings p_i45560_5_)
    {
        super(p_i45560_1_);
        ...
        biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(BiomeInit.MARSCANYON, 10));
        biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(BiomeInit.MARSHILLS, 20));
        biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(BiomeInit.MARSFLATS, 30)); 
        
        desertIdx = net.minecraftforge.common.BiomeManager.BiomeType.WARM.ordinal();
        ...
        desertIdx = net.minecraftforge.common.BiomeManager.BiomeType.COOL.ordinal();
        biomes[desertIdx].clear();
        ...
        desertIdx = net.minecraftforge.common.BiomeManager.BiomeType.ICY.ordinal();
        biomes[desertIdx].clear();
